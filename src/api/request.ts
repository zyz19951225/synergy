...
const baseURL = process.env.NODE_ENV === 'development'? 'https://mock.mengxuegu.com/mock/63870dcb93a67b5f10668dd4/synergy' : 'https://your.domain.com/api';
...
const requestHandler = <T>(method: 'get' | 'post' | 'put' | 'delete', url: string, params: object = {}, config: AxiosRequestConfig = {}):
    Promise<T> => {
